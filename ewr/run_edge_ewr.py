...
key_file = '/home/erosolow/code/phangs_pipeline_configs/edge/edge_keys/master_key.txt'

# Set directory for the pipeline and change to this directory
pipedir = '/mnt/space/erosolow/phangs_imaging_scripts/'

sys.path.append('/home/erosolow/code/analysis_scripts/')
os.chdir(pipedir)
...
gals = ['UGC04455',
        ...
        'NGC7364', 'UGC11982',
        'NGC2449',
        'UGC04240','UGC11680NED02','VV488NED02']
